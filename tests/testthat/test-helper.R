...
test_that("get_crit returns NA if sample size is too small", {
  design <- setupBasket(k = 3, shape1 = 1, shape2 = 1, theta0 = 0.7,
...
test_that("get_crit_pool returns NA if sample size is too small", {
  design <- setupBasket(k = 3, shape1 = 1, shape2 = 1, theta0 = 0.8,
...
test_that("prune_weights works", {
  design <- setupBasket(k = 6, shape1 = 1, shape2 = 1, theta0 = 0.2,
    theta1 = rep(0.5, 6))
