test_that("adjust_lambda works", {
  ...
  adj_res1 <- adjust_lambda(design = design, alpha = 0.025, n = 15,
    weight_fun = weights_fujikawa, tuning_params = list(epsilon = 1, tau = 0,
  ...
  adj_res3 <- adjust_lambda(design = design, alpha = 0.025, n = 15,
    weight_fun = weights_fujikawa, tuning_params = list(epsilon = 4,
  ...
  toer_adj3 <- toer(design = design, n = 15, lambda = adj_res3$lambda,
    weight_fun = weights_fujikawa, tuning_params = list(epsilon = 4, tau = 0,
    logbase = 2, prune = FALSE), results = "fwer")
